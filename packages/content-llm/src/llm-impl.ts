...
export class LlmApi implements ILlmApi {
  ...
  connect(options: ConnectOptions): void {
    this.provider = createRemoteProvider(options.provider as ProviderName, options.apiKey);
  }
  ...
  async *streamChatCompletion(options: ChatCompletionOptions): AsyncGenerator<StreamPart> {
