import type { AssistantModelMessage, ModelMessage, ToolResultPart as SdkToolResultPart } from "ai";
import type {
...
function convertAssistantContent(msg: AssistantModelMessage): string | AssistantContentPart[] {
